	...
	*/
	...
	// estruturas para propagacao de erros ao usuario.
		...
		enum _config_error {
			...
			E_NOTVALID_CP_INDEX = -13, E_NEG_ARR_SIZE = -14, E_NULL_POINTER = -15, E_ARR_NOT_FOUND = -16, E_NOT_VALID_MARRAY_INFO = -17,
			E_NOT_SUPPORTED_ARRAY_TYPE = -18, E_DISTINCT_MARRAY_DIMENSIONS = -19, E_NOT_SUPPORTED_INSTRUCTION = -20,
			E_BAD_INPUT = -21, E_NEGATIVE_ARRAY_SIZE = -22
		};
